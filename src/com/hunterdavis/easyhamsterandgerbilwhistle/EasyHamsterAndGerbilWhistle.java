package com.hunterdavis.easyhamsterandgerbilwhistle;
...
public class EasyHamsterAndGerbilWhistle extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener dogThreeListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 64250);
			}
		};
		...
		OnClickListener dogFourListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 65100);
			}
		};
